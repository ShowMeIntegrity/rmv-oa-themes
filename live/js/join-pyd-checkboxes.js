(function () {
    const MAX_CHECKED = 2;
    const FIELDSET_SELECTOR = "#NVSignupForm2650313-AdditionalInformation";
    const SUPPORT_SELECTOR = "#NVSignupForm2650313-AdditionalInformation-CustomFormFieldQuestion_279192822981958_MappedCustomFormFieldQuestion_180-select";
    const MORE_INFO_VALUE = "1";
    const AGREEMENT_LINK_CONFIG = [
        {
            selector: '#NVSignupForm2650313-AdditionalInformation-CustomFormFieldQuestion_8823170002624335-label',
            matchText: 'Excellence Pledge',
            url: 'https://respectmovoters.org/excellence-pledge',
            popupName: 'excellencePopup'
        },
        {
            selector: '#NVSignupForm2650313-AdditionalInformation-CustomFormFieldQuestion_2087973607584309-label',
    ...
    function init(fieldset){
        ...
        const checkboxes = fieldset.querySelectorAll(
            'input[name^="CustomFormFieldQuestion_5409071557649571_"]'
        );
